            ...
            <div class="row">
                <div class="col-md-6">
                        ...
                        <form class="form-horizontal" >
                            <div class="card-body">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-2">
                                        <input type="text" class="form-control Exp" id="ses_id" value="123" disabled>
                                    </div>
                                    <div class="col-sm-7">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-2">
                                        <input type="text" class="form-control Exp" id="nivel_id" value="1" disabled>
                                    </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-2">
                                        <input type="text" class="form-control dato Exp" id="genCop_id" value="1" name = "inp">
                                    </div>
                                    <div class="col-sm-7">
                                        <input type="text" class="form-control dato Exp" placeholder="Original" id = "genCop_alias"  disabled="">
                                        <!--
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-2">
                                        <input type="text" class="form-control dato Exp" id="esc_code1" value="0" onFocus="this.select()"  name = "inp" autofocus>
                                    </div>
                                    <div class="col-sm-7">
                        ...
                        <form class="form-horizontal">
                            <div class="card-body">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-2">
                                        <input type="text" class="form-control dato Exp" id="org_id" value="7"  name = "inp">
                                    </div>
                                    <div class="col-sm-7">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-2">
                                        <input type="text" class="form-control dato Exp" id="sesTipo_id" value="1" disabled  name = "inp">
                                    </div>
                                    <div class="col-sm-7">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-5">
                                        <div class="input-group" data-children-count="1">
                                            ...
                                            <input type="text" class="form-control dato Exp" data-inputmask-alias="datetime"
                                                data-inputmask-inputformat="dd/mm/yyyy" data-mask=""
                                                inputmode="numeric" id = "ses_fecha"  name = "inp" disabled>
                                        </div>
                                    </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-5">
                                        <div class="input-group" data-children-count="1">
                                            ...
                                            <input type="text" class="form-control dato Exp" data-inputmask-alias="datetime"
                                                data-inputmask-inputformat="dd/mm/yyyy" data-mask=""
                                                inputmode="numeric" id = "resol_fecha"  name = "inp">
                                        </div>
                                    </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-5">
                                        <input type="text" class="form-control dato Exp" id="resol_numero" placeholder="Número de Doc."  name = "inp">
                                    </div>
                                </div>
                    ...
                    <div class="card card-danger">
                        ...
                        <form class="form-horizontal" id = "formExp">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-6">
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        <div class="input-group" data-children-count="1">
                                            ...
                                            <input type="text" class="form-control dato Exp" data-inputmask-alias="datetime"
                                                data-inputmask-inputformat="dd/mm/yyyy" data-mask=""
                                                inputmode="numeric" id = "resol_fechaSolicitud"  name = "inp">
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <input type="text" class="form-control dato Exp" placeholder="Número" id = "resol_nroSolicitud"  name = "inp">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-6">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <input type="text" class="form-control dato Exp" placeholder="Memorando" id= " resol_memorando"  name = "inp">
                                    </div>
                                </div>
                            </div>
                        </form>
                        ...
                        <form class="form-horizontal" id="persona_form1">
                            <div class="card-body">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-4">
                                        <input type="text" class="form-control dato Exp" id="per_nroDoc1"
                                            placeholder="Ingrese Número de Doc."  name = "inp">
                                    </div>
                                    <div class="col-sm-5">
                        ...
                        <form class="form-horizontal" id="formExp1">
                            <div class="card-body">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-2">
                                        <input type="text" class="form-control dato Exp" id="actAca_id" value="6"  name = "inp">
                                    </div>
                                    <div class="col-sm-7">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-5">
                                        <div class="input-group" data-children-count="1">
                                            ...
                                            <input type="text" class="form-control dato Exp" data-inputmask-alias="datetime"
                                                data-inputmask-inputformat="dd/mm/yyyy" data-mask=""
                                                inputmode="numeric" id = "fecha_actAca" name = "inp">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <select class="form-control select2 select2-hidden-accessible Exp" style="width: 100%;"
                                            data-select2-id="1" aria-hidden="true" id="den_id" name = "inp">
