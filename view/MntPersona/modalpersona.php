        ...
        <div class="modal-content">
            <form method="post" id="persona_form">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label class="form-label" for="per_sexo">Genero</label>
                        <br>
                        <div class="form-check">
                          <input class="form-check-input" type="radio" name="per_sexo" id="per_sexo" value="M" required>
              ...
              <!-- 
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control select2 select2-hidden-accessible" style="width: 100%;" data-select2-id="1" tabindex="-1" aria-hidden="true" id="docTipo_id" name="docTipo_id">
