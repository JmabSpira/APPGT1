  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="../Home/" class="brand-link">
      <img src="../../public/dist/img/UnschLogo.png" alt="UNSCH Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
      <span class="brand-text font-weight-light">APP GT UNSCH</span>
    </a>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="../MntDiploma/" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Diplomas</p>
                </a>
              </li>
          ...
          <li class="nav-header">CUADRO MULTI LEVEL</li>
          <li class="nav-item">
            <a href="#" class="nav-link">
